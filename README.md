...
Goal: Predict whether an individual’s income is greater than $50K using demographic features.

Tools: The model was developed using Python, with libraries such as scikit-learn, pandas, matplotlib, and seaborn for data analysis and model building.
